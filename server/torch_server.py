...
from my_code import FedML_Horizontal_code as fedml_code
# from my_code.FedML_Horizontal_code import FedML_Horizontal
...
class Server:
    def __init__(self, args, device, dataset, model, model_trainer=None):
        if args.federated_optimizer == "FedAvg":
            self.fl_trainer = fedml_code.FedML_Horizontal(
                args,
                0,
                args.worker_num,
                None,
